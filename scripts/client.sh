...
scp -o "StrictHostKeyChecking no" ${USERNAME}@${SERVER}:k3s-config ../config
scp -o "StrictHostKeyChecking no" ${USERNAME}@${SERVER}:node-token ../config
...
cp ../config/k3s-config /c/Users/pelleo/.kube/config

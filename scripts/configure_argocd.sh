...
# Repo information.  Use env var GIT_HUB_USERNAME to determine
# if script is running locally or remotely.
[[ -z ${GIT_HUB_USERNAME} ]] && repo_url=${GITHUB_SERVER_URL}/${GITHUB_REPOSITORY} || repo_url=https://github.com/${GIT_HUB_USERNAME}/Hybrid.IoTHub.Deployment.git
